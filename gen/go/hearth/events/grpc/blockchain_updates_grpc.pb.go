...
const (
	BlockchainUpdatesApi_GetBlockUpdate_FullMethodName       = "/hearth.events.grpc.BlockchainUpdatesApi/GetBlockUpdate"
	BlockchainUpdatesApi_GetBlockUpdatesRange_FullMethodName = "/hearth.events.grpc.BlockchainUpdatesApi/GetBlockUpdatesRange"
	BlockchainUpdatesApi_Subscribe_FullMethodName            = "/hearth.events.grpc.BlockchainUpdatesApi/Subscribe"
)
...
// All implementations must embed UnimplementedBlockchainUpdatesApiServer
...
// UnimplementedBlockchainUpdatesApiServer must be embedded to have
...
func (UnimplementedBlockchainUpdatesApiServer) GetBlockUpdate(context.Context, *GetBlockUpdateRequest) (*GetBlockUpdateResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBlockUpdate not implemented")
}
func (UnimplementedBlockchainUpdatesApiServer) GetBlockUpdatesRange(context.Context, *GetBlockUpdatesRangeRequest) (*GetBlockUpdatesRangeResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetBlockUpdatesRange not implemented")
}
...
func (UnimplementedBlockchainUpdatesApiServer) mustEmbedUnimplementedBlockchainUpdatesApiServer() {}
...
func RegisterBlockchainUpdatesApiServer(s grpc.ServiceRegistrar, srv BlockchainUpdatesApiServer) {
	// If the following call panics, it indicates UnimplementedBlockchainUpdatesApiServer was
...
var BlockchainUpdatesApi_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "hearth.events.grpc.BlockchainUpdatesApi",
	...
	Metadata: "hearth/events/grpc/blockchain_updates.proto",
}
